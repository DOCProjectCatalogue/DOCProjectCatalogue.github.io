...
[bloodSheltie](https://github.com/alexandre-normand/bloodSheltie) | A Dexcom G4 sync api as an Objective-C Framework | Dexcom CGM | ..
[blueReader](https://unendlichkeit.net/wordpress/?lang=en) | Easy way to read NFC tags wirelessly via Bluetooth. Supports all formats, including medical systems like Abbott's Freestyle Libre ([more](https://www.startnext.com/bluereader))| Libre | ..
[Carelink Notificator](https://github.com/bustavo/carelink_notificator) | Ruby script that uses decoding-carelink to download Glucose History from Medtronic pumps and sends notifications to services such as Pushover | Medtronic CGM | ..
...
[dexcom](https://github.com/ecc1/dexcom) | Go package for communicating with a Dexcom continuous glucose monitor | Dexcom CGM | ..
...
[DexcomShareDashclock](https://github.com/c99koder/DexcomShareDashclock) | Display current glucose reading from Dexcom Share on Dashclock and Android Wear | Dexcom CGM | ..
...
[Dextender](https://github.com/mlivolsi63/Dextender) | .. | .. | ..
...
[Glukit](https://github.com/alexandre-normand/glukit) | Diabetes Management App With Behavioral Science Sauce for Type 1 Diabetics | .. | ..
...
[LimiTTer](https://github.com/JoernL/LimiTTer) | With the LimiTTer you are able to transform the Freestyle Libre FGM system into a real Continous Glucose Monitoring System (CGMS) | Libre | Android
...
[medtronic](https://github.com/ecc1/medtronic) | Go package for communicating with Medtronic insulin pumps via SPI-attached radio modules | Medtronic Pumps | ..
...
[Nightscout Indicator](https://github.com/beached/nightscout_indicator) | A simple indicator that runs in Ubuntu/Gnome | .. | Linux
[NightscoutLoader](https://github.com/gh-davidr/NightscoutLoader) | A Java application that can synchronize meter/pump data with Nightscout, offers a quick way to modify notes field in treatment data and includes deep trend analysis of this data. | .. | ..
...
[NightscoutHybridMobile](https://github.com/aditmer/NightscoutHybridMobile) | A cross platform mobile app that shows your Nightscout website in a WebView | .. | ..
[NightScoutNative](https://github.com/aditmer/NightScoutNative) | A native iOS and Android app client for Nightscout | .. | ..
...
[oref0 tools](https://github.com/sulkaharo/oref0-tools) | Tools used with the oref0 closed loop artificial pancreas and Nightscout | .. | ..
...
[Roundtrip](https://github.com/TC2013/Roundtrip) | A limited port of OpenAPS (author Ben West) into an Android application | .. | Android
[Roundtrip2](https://github.com/TC2013/Roundtrip2) | .. | .. | Android
...
[sugarbar](https://github.com/virmani/sugarbar) | Your blood sugar in the mac's menubar | Dexcom CGM | OS X
...
[watchSugar](https://github.com/adamawolf/watchSugar) | An Apple Watch Extension for viewing your Dexcom Share blood sugars on your watch face | Dexcom CGM | Apple Watch
